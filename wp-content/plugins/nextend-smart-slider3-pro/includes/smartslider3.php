    ...
    public static function upgrader_pre_download($reply, $package, $upgrader) {
        ...
        switch ($status) {
            ...
            case 'LICENSE_EXPIRED':
                $message = 'Your <a href="http://doc.smartslider3.com/article/1101-license" target="_blank">license</a> expired! Get new one: <a href="https://smartslider3.com/pricing" target="_blank">smartslider3.com</a>';
                break;
            ...
            case 'PLATFORM_NOT_ALLOWED':
                $message = 'Your <a href="http://doc.smartslider3.com/article/1101-license" target="_blank">license key</a> is not valid for WordPress! Get a license for WordPress: <a href="https://smartslider3.com/pricing" target="_blank">smartslider3.com</a>';
                break;
            case null:
