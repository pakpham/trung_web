...
class N2SSPluginItemFactoryArea extends N2SSPluginItemFactoryAbstract {
    ...
    public function getTemplate($slider) {
        ...
        return '<span class="n2-ow" style="display:inline-block;vertical-align:top;width:{width};height:{height};background-color:{colora};opacity:{opacity};border:{borderWidth} solid {borderColora};border-radius:{borderRadius};-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;{css}"></span>';
    }
