...
class N2SSPluginItemFactoryInput extends N2SSPluginItemFactoryAbstract {
    ...
    function getTemplate($slider) {
        ...
        return N2Html::tag('div', array(
            ...
            'cellpadding' => 0,
            'cellspacing' => 0
        ), N2Html::tag('tr', array('class' => 'n2-ow'), N2Html::tag('td', array(
                'style' => '{fullwidthStyle}',
                'class' => 'n2-ow'
            ), "<div class='n2-fake-input n2-ow {inputfontclass} {inputstyleclass}' style='width:100%;white-space:nowrap;'>{placeholder}</div>") . N2Html::tag('td', array(
                'class' => 'n2-ow'
            ), N2Html::tag('div', array(
                'style' => 'white-space:nowrap;display:inline-block',
                'class' => '{buttonfontclass} {buttonstyleclass} n2-ow'
            ), '{buttonlabel}')))));
    }
