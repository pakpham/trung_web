				...
				'groups' => [
					[
						...
						'options' => [
							...
							'enter-zoom-in' => __( 'Zoom In', 'elementor-pro' ),
							'enter-zoom-out' => __( 'Zoom Out', 'elementor-pro' ),
					...
					[
						...
						'options' => [
							'exit-to-right' => __( 'Slide Out Right', 'elementor-pro' ),
							'exit-to-left' => __( 'Slide Out Left', 'elementor-pro' ),
							'exit-to-top' => __( 'Slide Out Up', 'elementor-pro' ),
							'exit-to-bottom' => __( 'Slide Out Down', 'elementor-pro' ),
							'exit-zoom-in' => __( 'Zoom In', 'elementor-pro' ),
							'exit-zoom-out' => __( 'Zoom Out', 'elementor-pro' ),
							'fade-out' => __( 'Fade Out', 'elementor-pro' ),
						]
					],
				],
				'default' => 'grow',
